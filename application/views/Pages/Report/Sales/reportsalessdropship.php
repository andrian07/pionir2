...
<div class="container">
  <div class="page-inner">
    ...
    <div class="row">
      <h3 class="fw-bold mb-3">Laporan Penjualan Dropship</h3>
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <div class="card-body">
              <form>
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <!-- text input -->
                    <div class="form-group">
                      <label>Nama Dropship :</label>
                      <input type="text" class="form-control input-full" id="dropship_name" name="dropship_name" placeholder="Nama Dropship">
                    </div>
                  </div>
        ...
        <div class="card">
          <div class="card-body">
            <iframe id="preview" src="<?php echo base_url(); ?>Reportsales/reportsalessdropshippdf" width="100%" height="1000px"></iframe>
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    $('#btnsearch').click(function(e) {
      ...
      let dropship_name    = $('#dropship_name').val();
      let warehouse_report = $('#warehouse_report').val();

      let url = '<?php echo base_url(); ?>Reportsales/reportsalessdropshippdf?';
      url += '&start_date=' + start_date;
      url += '&end_date=' + end_date;
      url += '&customer_report=' + customer_report;
      url += '&dropship_name=' + dropship_name;
    ...
    $('#btndownloadexcell').click(function(e) {
      ...
      let dropship_name    = $('#dropship_name').val();
      let warehouse_report = $('#warehouse_report').val();
      let url = '<?php echo base_url(); ?>Reportsales/reportsalessdropship_excell?';
      url += '&start_date=' + start_date;
      url += '&end_date=' + end_date;
      url += '&customer_report=' + customer_report;
      url += '&dropship_name=' + dropship_name;
